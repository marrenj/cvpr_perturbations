...
def main(): 
    ...
    config = {
        ...
        'training_res_path': '/home/wallacelab/teba/multimodal_brain_inspired/marren/temporal_dynamics_of_human_alignment/baseline_runs/clip_hba_behavior_seed1/training_results/training_res_seed1.csv',  # Path to training results CSV for filtering epochs by minimum test loss
        ...
        'output_dir': '/home/wallacelab/teba/multimodal_brain_inspired/marren/temporal_dynamics_of_human_alignment/baseline_runs/clip_hba_behavior_seed1/inference_results/nights_inference_results',  # Directory to save results
