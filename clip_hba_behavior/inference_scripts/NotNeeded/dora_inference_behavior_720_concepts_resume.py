from functions.dora_inference_behavior_pipeline_720_concepts_optimized_resume import run_behavior_inference
...
def main(): 
    ...
    config = {
        ...
        'model_path': './models/cliphba_behavior_20250919_203625.pth',  # path to the final trained model
        'dora_params_path': './dora_params_20250919_212703',  # path to the dora parameters
        'save_folder': './output/cliphba_behavior/20250919_212703',  # output path
        'batch_size': 32,  # batch size (increased for better GPU utilization)
        'cuda': "cuda:1",  # 'cuda:0' for GPU 0, 'cuda:1' for GPU 1, '-1' for all GPUs
        'start_epoch': 34,  # Starting epoch for DoRA parameter processing
