...
from functions.train_behavior_things_baseline_pipeline_marren_random_targets_resume import run_behavioral_traning

def main():
    # Use the existing timestamp from the previous training run
    timestamp = "20250919_203625"
    ...
    config = {
        ...
        'random_target_epoch': 2,
        'random_target_seed': 42,
        'resume_from_epoch': 113,  # Start training from epoch
