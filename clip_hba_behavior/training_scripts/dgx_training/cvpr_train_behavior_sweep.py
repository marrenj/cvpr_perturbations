...
def main():
    ...
    config = {
        ...
        'perturb_type': 'uniform_target', # either 'random_target', 'label_shuffle', or 'uniform_target'
        ...
        'output_base_directory': '/data/p_dsi/dhungs1/uniform_target_single_epoch_perturbation_sweeps/perturb_sweep_baselineseed1_perturbseed42', # base directory for saving the training results and artifacts
    }
