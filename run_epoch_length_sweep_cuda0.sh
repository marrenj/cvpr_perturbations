...
export IMG_DIR="${IMG_DIR:-/home/jenkm22/cvpr_perturbations/THINGS_images/THINGS_images}"
export CUDA=0
...
PERTURB_SEEDS=(1 2 3)
RESUME_FROM="vit_l_14_rank32_perturb-type-random_target_epoch39_length20_perturb-seed3_init-seed3behavioral-rsa-True"
